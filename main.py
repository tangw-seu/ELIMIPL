...
# training settings
parser = argparse.ArgumentParser(description='ELIMIPL')
...
parser.add_argument('--gamma', type=float, default=1.0, metavar='L', help='the weight of the inhibition loss')
parser.add_argument('--mu', type=float, default=1.0, metavar='L', help='the weight of the sparsity loss')
parser.add_argument('--L', type=int, default=128, metavar='S', help='the embedded space dimension')
...
if __name__ == "__main__":
    time_s = time.time()
    rho_list = adjust_rho(args.epochs)
    num_trial = 1
